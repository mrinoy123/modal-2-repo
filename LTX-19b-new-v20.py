...
base_image = modal.Image.from_registry(
    ...
    "FORCE_REBUILD_INDEX": "122"  # Bumped to force the new Streaming Architecture
})
            ...
            try:
                async with aiohttp.ClientSession() as session:
                    ...
                    await asyncio.get_event_loop().run_in_executor(
                        None, self.s3.upload_file, "video-asset-files-storage-workflow", target_video_file, target_key
                    )
